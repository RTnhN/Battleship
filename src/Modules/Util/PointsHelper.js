...
class PointsHelper {
  ...
  */
  ...
  static doLineSegmentsIntersect(p, p2, q, q2) {
    const r = PointsHelper.subtractPoints(p2, p);
    const s = PointsHelper.subtractPoints(q2, q);

    const uNumerator = PointsHelper.crossProduct(PointsHelper.subtractPoints(q, p), r);
    const denominator = PointsHelper.crossProduct(r, s);
    ...
    const t = PointsHelper.crossProduct(PointsHelper.subtractPoints(q, p), s) / denominator;
